...
class __TwigTemplate_6b04fba042427fa88aec8d88c5d1e967 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["url"] ?? null)) {
            ...
            yield "\">";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["responsive_image"] ?? null), 16, $this->source), "html", null, true);
            yield "</a>
";
        } else {
            // line 18
            yield "  ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["responsive_image"] ?? null), 18, $this->source), "html", null, true);
            yield "
";
        }
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["url", "responsive_image"]);        return; yield '';
    }
    ...
    {
        return array (  50 => 18,  42 => 16,  40 => 15,);
    }
